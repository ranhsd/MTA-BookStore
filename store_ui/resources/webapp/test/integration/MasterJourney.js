sap.ui.define([
		...
		opaTest("MasterList Filtering on numberOfBooks less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("numberOfBooks").
		...
		opaTest("MasterList Filtering on numberOfBooks more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 ").
				and.iPressOKInViewSelectionDialog();
