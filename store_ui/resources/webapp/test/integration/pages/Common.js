sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/demo/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.sap.demo.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/demo/localService/mockserver"], function (mockserver) {
