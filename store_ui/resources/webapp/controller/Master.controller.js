/*global history */
sap.ui.define([
	"com/sap/demo/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/sap/demo/model/formatter",
	"com/sap/demo/model/grouper",
	...
	"use strict";
	return BaseController.extend("com.sap.demo.controller.Master", {
		formatter: formatter,
		_oCreateBookDialog: null,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		/**
		...
		onSearch: function(oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("authorName", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.sap.demo.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function(oEvent) {
			...
			aFilterItems.forEach(function(oItem) {
				switch (oItem.getKey()) {
					case "Filter1":
						aFilters.push(new Filter("numberOfBooks", FilterOperator.LE, 100));
						break;
					case "Filter2":
						aFilters.push(new Filter("numberOfBooks", FilterOperator.GT, 100));
						break;
					default:
						break;
				}
		...
		_onMasterMatched: function() {
			this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(function(mParams) {
				...
				var sObjectId = mParams.firstListitem.getBindingContext().getProperty("authorId");
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				objectId: oItem.getBindingContext().getProperty("authorId")
			}, bReplace);
		},
		/**
		...
		/**
		 *@memberOf com.sap.demo.controller.Master
		 */
